...
class TORCH_API TensorMaker {
 ...
 public:
  ...
  TensorMaker& storage_offset(std::optional<int64_t> value) noexcept {//gwp_modified
  ...
  TensorMaker& target_device(c10::optional<Device> value) noexcept {//gwp_modified
    device_ = value;
 ...
 private:
  ...
  std::optional<int64_t> storage_offset_{};//gwp_modified
  std::function<void(void*)> deleter_{};
  std::unique_ptr<void, ContextDeleter> ctx_{nullptr, detail::noopDelete};
  c10::optional<Device> device_{};//gwp_modified
  TensorOptions opts_{};
};
